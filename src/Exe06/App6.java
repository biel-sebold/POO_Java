...
// 9. Crie um programa (classe App) que solicite ao usuário o número e titular de duas contas bancárias. 
...
public class App6 {
    public static void main(String[] args) {
        ...
        System.out.println("\n\n### EXIBIÇÃO ###");
        System.out.println("\nCONTA 1:");
        System.out.printf("\nTitular: %s", conta1.getTitular());
        System.out.printf("\nSaldo: R$%.2f", conta1.getSaldo());        
        System.out.println("\n\nCONTA 2:");
        System.out.printf("\nTitular: %s", conta2.getTitular());
        System.out.printf("\nSaldo: R$%.2f", conta2.getSaldo());
    }
